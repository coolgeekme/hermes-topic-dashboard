                  ...
                  <div className="flex flex-col h-full gap-1.5">
                    ...
                    <div className="flex items-center gap-1.5">
                      <span
                        ...
                        style={{ backgroundColor: isMultiPlatform ? '#fbbf24' : accent.dot }}
                      />
                        ...
                        <div className="flex gap-0.5">
                          {topic.platforms.map((p) => {
                            ...
                            return (
                              <span
                                key={p}
                                className="text-[8px] px-1 py-0.5 rounded-full font-medium uppercase tracking-wider"
                                style={{ backgroundColor: pc.bg, color: pc.dot, border: `1px solid ${pc.dot}30` }}
                              >
                                {p === 'claude-code' ? 'CL' : p === 'hermes' ? 'HE' : p[0]}
                              </span>
                            )
                          })}
                        </div>
                      ...
                      {isMultiPlatform && (
                        <span className="text-[9px] text-amber-400/60">×{topic.platforms.length}</span>
                      )}
                    </div>
